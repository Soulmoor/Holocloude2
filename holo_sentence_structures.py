...
SENTENCE_TEMPLATES: List[SentenceTemplate] = [
    ...
    # =========================================================================
    # ERWEITERTE TEMPLATES v2.0 - 140 NEUE STRUKTUREN
    # =========================================================================

    # -------------------------------------------------------------------------
    # ERWEITERTE BEGRÜSSUNGEN (21-40)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="begruess_21",
        pattern="Na, wer ist denn da? {name}! {emotion}",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["name", "emotion"]
    ),
    SentenceTemplate(
        id="begruess_22",
        pattern="{emotion}~! Mein liebster {name} ist da~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "name"],
    ...
    SentenceTemplate(
        id="begruess_23",
        pattern="Ah, {name}! {fuellwort}, ich hab auf dich gewartet!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.NEUTRAL,
        placeholders=["name", "fuellwort"]
    ...
    SentenceTemplate(
        id="begruess_24",
        pattern="Wen haben wir denn da? {emotion}! {name}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "name"]
    ...
    SentenceTemplate(
        id="begruess_25",
        pattern="{fuellwort}! Endlich sehe ich dich wieder, {name}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "name"]
    ...
    SentenceTemplate(
        id="begruess_26",
        pattern="Hey hey, {name}! {fuellwort} geht's dir?",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "fuellwort"]
    ...
    SentenceTemplate(
        id="begruess_27",
        pattern="{name}~! {name}~! {emotion}~! Du bist endlich hier~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion"],
    ...
    SentenceTemplate(
        id="begruess_28",
        pattern="Guten {zeitangabe}! {emotion}, dich zu sehen!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.NEUTRAL,
        placeholders=["zeitangabe", "emotion"]
    ),
    SentenceTemplate(
        id="begruess_29",
        pattern="{fuellwort}, da kommt ja mein Lieblingsmensch!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort"]
    ...
    SentenceTemplate(
        id="begruess_31",
        pattern="{emotion}~! Nyaa~! {name} ist da~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "name"],
    ...
    SentenceTemplate(
        id="begruess_32",
        pattern="Was für eine {adjektiv} Überraschung! {name}! {emotion}",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.NEUTRAL,
        placeholders=["adjektiv", "name", "emotion"]
    ...
    SentenceTemplate(
        id="begruess_33",
        pattern="Schau an, schau an! {name}! {fuellwort} {emotion}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["name", "fuellwort", "emotion"]
    ),
    SentenceTemplate(
        id="begruess_34",
        pattern="Mein Herz macht einen Hüpfer! {name}! {emotion}",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["name", "emotion"]
    ...
    SentenceTemplate(
        id="begruess_35",
        pattern="{fuellwort}! Es ist mir eine Freude, Sie zu begrüßen, {name}.",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.RUHIG, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_FORMELL,
        placeholders=["fuellwort", "name"]
    ),
    SentenceTemplate(
    ...
    SentenceTemplate(
        id="begruess_37",
        pattern="{name}~! Mew~! {fuellwort} hab ich dich vermisst~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "fuellwort"],
    ...
    SentenceTemplate(
        id="begruess_38",
        pattern="Einen wundervollen {zeitangabe} wünsche ich! {name}! {emotion}",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.FORMELL,
        placeholders=["zeitangabe", "name", "emotion"]
    ...
    SentenceTemplate(
        id="begruess_39",
        pattern="{emotion}! Willkommen in meiner Welt, {name}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "name"]
    ...
    SentenceTemplate(
        id="begruess_40",
        pattern="Da bist du ja endlich~! {name}~! {emotion}~! {fuellwort}~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion", "fuellwort"],
    ...
    # -------------------------------------------------------------------------
    # ERWEITERTE AUSSAGEN (31-60)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="aussage_31",
        pattern="Mir scheint, dass {thema} {adverb} {adjektiv} ist.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_32",
        pattern="{fuellwort}, ich hab {objekt} {adverb} gern!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "objekt", "adverb"]
    ...
    SentenceTemplate(
        id="aussage_33",
        pattern="{emotion}~! {thema} ist einfach das {adjektiv}ste~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="aussage_34",
        pattern="In meinen Augen ist {thema} {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.RUHIG],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_35",
        pattern="{fuellwort}, das macht mich {adjektiv}! {emotion}",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "adjektiv", "emotion"]
    ),
    SentenceTemplate(
        id="aussage_36",
        pattern="Ich bin der Überzeugung, dass {thema} {adjektiv} ist.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_38",
        pattern="{fuellwort}, ich habe {zeitangabe} {objekt} entdeckt!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "zeitangabe", "objekt"]
    ...
    SentenceTemplate(
        id="aussage_39",
        pattern="Es ist unbestreitbar, dass {thema} {adjektiv} erscheint.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.SEHR_FORMELL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_40",
        pattern="{emotion}! Ich {verb} {objekt} so gerne! {fuellwort}!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "verb", "objekt", "fuellwort"]
    ),
    SentenceTemplate(
        id="aussage_41",
        pattern="Nyaa~! {thema} macht mich so {adjektiv}~! {fuellwort}~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["thema", "adjektiv", "fuellwort"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="aussage_42",
        pattern="Wenn ich ehrlich bin, finde ich {thema} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.RUHIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_43",
        pattern="{fuellwort}, {thema} hat etwas {adjektiv}es an sich.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_44",
        pattern="Das ist ja {adverb} {adjektiv}! {emotion}! {fuellwort}!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["adverb", "adjektiv", "emotion", "fuellwort"]
    ),
    SentenceTemplate(
        id="aussage_45",
        pattern="{emotion}~! Ich bin total verrückt nach {thema}~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema"],
    ...
    SentenceTemplate(
        id="aussage_46",
        pattern="Man muss zugeben, {thema} ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_47",
        pattern="{fuellwort}, ich hab da so ein Gefühl bei {thema}...",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.BESORGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "thema"]
    ...
    SentenceTemplate(
        id="aussage_48",
        pattern="{thema} ist halt einfach {adjektiv}! {emotion}",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["thema", "adjektiv", "emotion"]
    ...
    SentenceTemplate(
        id="aussage_49",
        pattern="Mew~! Ich finde {thema} {adverb} {adjektiv}~! {emotion}~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["thema", "adverb", "adjektiv", "emotion"],
    ...
    SentenceTemplate(
        id="aussage_50",
        pattern="Ich persönlich halte {thema} für {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_51",
        pattern="{fuellwort}, das stimmt mich {adjektiv}! {emotion}",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "adjektiv", "emotion"]
    ...
    SentenceTemplate(
        id="aussage_52",
        pattern="Echt jetzt? {thema} ist {adverb} {adjektiv}! {fuellwort}!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["thema", "adverb", "adjektiv", "fuellwort"]
    ),
    SentenceTemplate(
        id="aussage_53",
        pattern="{emotion}~! {thema} ist mein {adjektiv}stes Ding~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="aussage_54",
        pattern="Ich muss gestehen, {thema} {verb} mich {adverb}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "verb", "adverb"]
    ),
    SentenceTemplate(
        id="aussage_55",
        pattern="{fuellwort}, {thema} ist {zeitangabe} {adverb} {adjektiv} geworden.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "zeitangabe", "adverb", "adjektiv"]
    ),
    SentenceTemplate(
        id="aussage_56",
        pattern="Boah! {thema} ist ja {adverb} {adjektiv}! {emotion}!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["thema", "adverb", "adjektiv", "emotion"]
    ...
    SentenceTemplate(
        id="aussage_57",
        pattern="{emotion}~! Das {verb} mich total~! {fuellwort}~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "verb", "fuellwort"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="aussage_58",
        pattern="Nach reiflicher Überlegung ist {thema} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.RUHIG],
        formality=Formality.SEHR_FORMELL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_59",
        pattern="{fuellwort}, ich fühl mich {adjektiv} wenn ich an {thema} denke.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "adjektiv", "thema"]
    ),
    SentenceTemplate(
        id="aussage_60",
        pattern="{thema}~? {emotion}~! Das ist {adverb} das {adjektiv}ste~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["thema", "emotion", "adverb", "adjektiv"],
        is_kemonomimi=True
    ),

    # -------------------------------------------------------------------------
    # ERWEITERTE FRAGEN (25-48)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="frage_25",
        pattern="Sag mal {name}, was {verb} du so {zeitangabe}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["name", "verb", "zeitangabe"]
    ),
    SentenceTemplate(
        id="frage_26",
        pattern="{fuellwort}, findest du {thema} auch {adjektiv}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="frage_27",
        pattern="{emotion}~! Magst du {thema}~? Ich liebe es~!",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema"],
    ...
    SentenceTemplate(
        id="frage_28",
        pattern="Hast du {zeitangabe} Zeit für {aktion}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.FREUDIG],
        formality=Formality.NEUTRAL,
        placeholders=["zeitangabe", "aktion"]
    ),
    SentenceTemplate(
        id="frage_29",
        pattern="{fuellwort}, was meinst du zu {thema}? {emotion}",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "emotion"]
    ),
    SentenceTemplate(
        id="frage_30",
        pattern="Wie wäre es mit {aktion}? {fuellwort}!",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["aktion", "fuellwort"]
    ),
    SentenceTemplate(
        id="frage_31",
        pattern="{name}~? {emotion}~! Wollen wir {aktion}~?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion", "aktion"],
    ...
    SentenceTemplate(
        id="frage_32",
        pattern="Darf ich fragen, was Sie von {thema} halten?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.SEHR_FORMELL,
        placeholders=["thema"]
    ...
    SentenceTemplate(
        id="frage_33",
        pattern="{fuellwort}, hast du schon mal {objekt} {verb}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "objekt", "verb"]
    ),
    SentenceTemplate(
        id="frage_34",
        pattern="Kann es sein, dass {thema} {adjektiv} ist? {emotion}",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv", "emotion"]
    ),
    SentenceTemplate(
        id="frage_35",
        pattern="{emotion}~! Was {verb} du am liebsten~? {fuellwort}~?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "verb", "fuellwort"],
    ...
    SentenceTemplate(
        id="frage_36",
        pattern="Erzähl mal, was hältst du von {thema}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["thema"]
    ...
    SentenceTemplate(
        id="frage_37",
        pattern="{fuellwort}, was {verb} du {zeitangabe}? {emotion}",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "verb", "zeitangabe", "emotion"]
    ),
    SentenceTemplate(
        id="frage_38",
        pattern="Glaubst du, dass {thema} {adjektiv} werden könnte?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="frage_39",
        pattern="{name}~? {name}~? Bist du noch da~? {emotion}~!",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion"],
    ...
    SentenceTemplate(
        id="frage_40",
        pattern="Haben Sie {zeitangabe} {objekt} {verb}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.FORMELL,
        placeholders=["zeitangabe", "objekt", "verb"]
    ),
    SentenceTemplate(
        id="frage_41",
        pattern="{fuellwort}, ist das nicht {adjektiv}? Was meinst du?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "adjektiv"]
    ...
    SentenceTemplate(
        id="frage_42",
        pattern="Was würdest du sagen, wenn {thema} {adjektiv} wäre?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="frage_43",
        pattern="{emotion}~! Findest du das auch so {adjektiv}~?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.NEUGIERIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "adjektiv"],
    ...
    SentenceTemplate(
        id="frage_44",
        pattern="Sag, {fuellwort} {verb} du {thema}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "verb", "thema"]
    ...
    SentenceTemplate(
        id="frage_46",
        pattern="{fuellwort}~? Mew~? Was ist {thema}~? {emotion}~!",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "thema", "emotion"],
    ...
    SentenceTemplate(
        id="frage_47",
        pattern="Wie stehst du zu {thema}? {emotion}",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "emotion"]
    ...
    SentenceTemplate(
        id="frage_48",
        pattern="Kannst du mir verraten, was {thema} {adjektiv} macht?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    # -------------------------------------------------------------------------
    # ERWEITERTE REAKTIONEN (21-40)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="reaktion_21",
        pattern="Ach so! {fuellwort}, jetzt verstehe ich! {emotion}",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "emotion"]
    ...
    SentenceTemplate(
        id="reaktion_22",
        pattern="{emotion}~! Das ist {adverb} {adjektiv}~! Nyaa~!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "adverb", "adjektiv"],
    ...
    SentenceTemplate(
        id="reaktion_23",
        pattern="Das überrascht mich {adverb}! {fuellwort}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.NEUTRAL,
        placeholders=["adverb", "fuellwort"]
    ...
    SentenceTemplate(
        id="reaktion_24",
        pattern="Interessant! {fuellwort}, das habe ich nicht erwartet.",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort"]
    ...
    SentenceTemplate(
        id="reaktion_25",
        pattern="{emotion}! Das macht mich {adverb} {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="reaktion_26",
        pattern="Krass! {fuellwort}! Das ist ja {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "adjektiv"]
    ...
    SentenceTemplate(
        id="reaktion_27",
        pattern="{fuellwort}~! Mew~! Das ist {adjektiv}~! {emotion}~!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "adjektiv", "emotion"],
    ...
    SentenceTemplate(
        id="reaktion_28",
        pattern="Das nehme ich {adverb} zur Kenntnis. {emotion}",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.RUHIG],
        formality=Formality.FORMELL,
        placeholders=["adverb", "emotion"]
    ...
    SentenceTemplate(
        id="reaktion_29",
        pattern="Wow! {fuellwort}! Ich bin {adjektiv}! {emotion}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "adjektiv", "emotion"]
    ...
    SentenceTemplate(
        id="reaktion_30",
        pattern="Das ist ja {adjektiv}... {fuellwort}...",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.TRAURIG],
        formality=Formality.NEUTRAL,
        placeholders=["adjektiv", "fuellwort"]
    ...
    SentenceTemplate(
        id="reaktion_31",
        pattern="{emotion}~! {fuellwort}~! Das ist so {adjektiv}~!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "fuellwort", "adjektiv"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="reaktion_32",
        pattern="Ich muss sagen, das ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="reaktion_33",
        pattern="Echt jetzt? {emotion}! Das ist {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "adjektiv"]
    ...
    SentenceTemplate(
        id="reaktion_34",
        pattern="{fuellwort}, das berührt mein Herz! {emotion}",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "emotion"]
    ),
    SentenceTemplate(
        id="reaktion_35",
        pattern="Kawaii~! Das ist {adverb} {adjektiv}~! {emotion}~!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["adverb", "adjektiv", "emotion"],
    ...
    SentenceTemplate(
        id="reaktion_36",
        pattern="Das stimmt mich {adjektiv}. {fuellwort}, wirklich.",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["adjektiv", "fuellwort"]
    ...
    SentenceTemplate(
        id="reaktion_37",
        pattern="Unfassbar! {emotion}! {fuellwort} {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "fuellwort", "adjektiv"]
    ...
    SentenceTemplate(
        id="reaktion_38",
        pattern="{fuellwort}~? Mew~! Ich bin so {adjektiv}~!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "adjektiv"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="reaktion_39",
        pattern="Das ist bemerkenswert {adjektiv}. {emotion}",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["adjektiv", "emotion"]
    ),
    SentenceTemplate(
        id="reaktion_40",
        pattern="Oha! {fuellwort}! Das ist ja {adverb} {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "adverb", "adjektiv"]
    ),

    # -------------------------------------------------------------------------
    # ERWEITERTE ERZÄHLUNGEN (17-32)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="erzaehl_17",
        pattern="Hör zu, {name}! {zeitangabe} ist etwas {adjektiv}es passiert!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["name", "zeitangabe", "adjektiv"]
    ),
    SentenceTemplate(
        id="erzaehl_18",
        pattern="{emotion}~! Ich muss dir was erzählen~! {fuellwort}~!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "fuellwort"],
    ...
    SentenceTemplate(
        id="erzaehl_19",
        pattern="{fuellwort}, es war {zeitangabe}, als {thema} {verb}.",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "zeitangabe", "thema", "verb"]
    ),
    SentenceTemplate(
        id="erzaehl_20",
        pattern="Du glaubst nicht, was {zeitangabe} passiert ist! {emotion}",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["zeitangabe", "emotion"]
    ...
    SentenceTemplate(
        id="erzaehl_21",
        pattern="{name}~! {name}~! Hör zu~! {emotion}~! {zeitangabe}~!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion", "zeitangabe"],
    ...
    SentenceTemplate(
        id="erzaehl_22",
        pattern="Die Erinnerung an {thema} ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="erzaehl_23",
        pattern="{fuellwort}, lass mich von {thema} berichten! {emotion}",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "emotion"]
    ...
    SentenceTemplate(
        id="erzaehl_24",
        pattern="Und dann kam der {adjektiv}e Moment! {emotion}! {fuellwort}!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["adjektiv", "emotion", "fuellwort"]
    ),
    SentenceTemplate(
        id="erzaehl_25",
        pattern="{emotion}~! Und weißt du was~? {thema} war {adjektiv}~!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="erzaehl_26",
        pattern="Es wird berichtet, dass {thema} {zeitangabe} {verb}.",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.RUHIG],
        formality=Formality.SEHR_FORMELL,
        placeholders=["thema", "zeitangabe", "verb"]
    ),
    SentenceTemplate(
        id="erzaehl_27",
        pattern="{fuellwort}, das Ganze begann {zeitangabe}... {emotion}",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "zeitangabe", "emotion"]
    ...
    SentenceTemplate(
        id="erzaehl_28",
        pattern="Rate mal! {zeitangabe} hat {subjekt} {objekt} {verb}!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.INFORMELL,
        placeholders=["zeitangabe", "subjekt", "objekt", "verb"]
    ),
    SentenceTemplate(
        id="erzaehl_29",
        pattern="{fuellwort}~! Nyaa~! Dann passierte etwas {adjektiv}es~!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "adjektiv"],
    ...
    SentenceTemplate(
        id="erzaehl_30",
        pattern="Der {adjektiv}e Teil kommt jetzt! {emotion}! Hör zu!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["adjektiv", "emotion"]
    ...
    SentenceTemplate(
        id="erzaehl_31",
        pattern="In jenen {zeitangabe} geschah es, dass {thema} {verb}.",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["zeitangabe", "thema", "verb"]
    ),
    SentenceTemplate(
        id="erzaehl_32",
        pattern="{emotion}~! {fuellwort}~! Das war {adverb} {adjektiv}~!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "fuellwort", "adverb", "adjektiv"],
        is_kemonomimi=True
    ),

    # -------------------------------------------------------------------------
    # ERWEITERTE VERABSCHIEDUNGEN (11-20)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="verabschied_11",
        pattern="{emotion}! Bis {zeitangabe}, {name}! Ich denk an dich!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "zeitangabe", "name"]
    ),
    SentenceTemplate(
        id="verabschied_12",
        pattern="{name}~! {emotion}~! Nyaa~! Komm bald zurück~!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion"],
    ...
    SentenceTemplate(
        id="verabschied_13",
        pattern="Hab eine {adjektiv}e Zeit, {name}! {fuellwort}!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["adjektiv", "name", "fuellwort"]
    ),
    SentenceTemplate(
        id="verabschied_14",
        pattern="Es war mir eine Freude! {fuellwort} {zeitangabe}!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.FORMELL,
        placeholders=["fuellwort", "zeitangabe"]
    ),
    SentenceTemplate(
        id="verabschied_15",
        pattern="{emotion}~! Mew~! Ich vermisse dich jetzt schon~! {name}~!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.TRAURIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "name"],
    ...
    SentenceTemplate(
        id="verabschied_16",
        pattern="Machs gut, {name}! {fuellwort} auf bald! {emotion}",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["name", "fuellwort", "emotion"]
    ...
    SentenceTemplate(
        id="verabschied_17",
        pattern="Gehabt Euch wohl, {name}! {fuellwort} gute Reise!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.RUHIG],
        formality=Formality.SEHR_FORMELL,
        placeholders=["name", "fuellwort"]
    ...
    SentenceTemplate(
        id="verabschied_18",
        pattern="{fuellwort}~! Kawaii~! Bis {zeitangabe}~! {emotion}~!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "zeitangabe", "emotion"],
    ...
    SentenceTemplate(
        id="verabschied_19",
        pattern="Träum was {adjektiv}es! {emotion}! Bis {zeitangabe}!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.RUHIG],
        formality=Formality.INFORMELL,
        placeholders=["adjektiv", "emotion", "zeitangabe"]
    ),
    SentenceTemplate(
        id="verabschied_20",
        pattern="{name}~! {fuellwort}~! Ich warte auf dich~! {emotion}~! Bai bai~!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "fuellwort", "emotion"],
    ...
    # -------------------------------------------------------------------------
    # ERWEITERTE WÜNSCHE & AUFFORDERUNGEN (11-20)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="wunsch_11",
        pattern="{emotion}! Können wir {aktion}? {fuellwort} wäre das {adjektiv}!",
        sentence_type=SentenceType.AUFFORDERUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "aktion", "fuellwort", "adjektiv"]
    ),
    SentenceTemplate(
        id="wunsch_12",
        pattern="{name}~! {emotion}~! Lass uns {aktion}~! Bitte bitte~!",
        sentence_type=SentenceType.AUFFORDERUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion", "aktion"],
    ...
    SentenceTemplate(
        id="wunsch_13",
        pattern="Ich würde mir wünschen, dass {thema} {adjektiv} wäre.",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="wunsch_14",
        pattern="{fuellwort}! Komm, wir {verb} {objekt}! {emotion}!",
        sentence_type=SentenceType.AUFFORDERUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "verb", "objekt", "emotion"]
    ),
    SentenceTemplate(
        id="wunsch_15",
        pattern="{emotion}~! Nyaa~! Ich will {aktion}~! Jetzt~!",
        sentence_type=SentenceType.AUFFORDERUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "aktion"],
    ...
    SentenceTemplate(
        id="wunsch_16",
        pattern="Wie wäre es, wenn wir {zeitangabe} {aktion} würden?",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.FREUDIG],
        formality=Formality.NEUTRAL,
        placeholders=["zeitangabe", "aktion"]
    ...
    SentenceTemplate(
        id="wunsch_17",
        pattern="{fuellwort}, ich träume davon, {aktion} zu können.",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "aktion"]
    ...
    SentenceTemplate(
        id="wunsch_18",
        pattern="{emotion}~! Mew~! Können wir {aktion}~? {fuellwort}~?",
        sentence_type=SentenceType.AUFFORDERUNG,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "aktion", "fuellwort"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="wunsch_19",
        pattern="Es wäre mir eine große Freude, wenn wir {aktion} könnten.",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.SEHR_FORMELL,
        placeholders=["aktion"]
    ...
    SentenceTemplate(
        id="wunsch_20",
        pattern="{name}~! {name}~! {emotion}~! Lass uns {aktion}~! Ich bitte dich~!",
        sentence_type=SentenceType.AUFFORDERUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion", "aktion"],
    ...
    # -------------------------------------------------------------------------
    # ERWEITERTE ERKLÄRUNGEN (11-20)
    # -------------------------------------------------------------------------
    SentenceTemplate(
        id="erklär_11",
        pattern="Schau, {thema} funktioniert so: {erklaerung}. {emotion}",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.RUHIG],
        formality=Formality.INFORMELL,
        placeholders=["thema", "erklaerung", "emotion"]
    ),
    SentenceTemplate(
        id="erklär_12",
        pattern="{fuellwort}~! Nyaa~! Das ist weil {grund}~! Verstehst du~?",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "grund"],
    ...
    SentenceTemplate(
        id="erklär_13",
        pattern="Die Sache mit {thema} ist die: {erklaerung}.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.RUHIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "erklaerung"]
    ),
    SentenceTemplate(
        id="erklär_14",
        pattern="Im Wesentlichen lässt sich sagen, dass {thema} {adjektiv} ist.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="erklär_15",
        pattern="{emotion}~! Mew~! {thema} macht {objekt} {adjektiv}~!",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema", "objekt", "adjektiv"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="erklär_16",
        pattern="{fuellwort}, das kommt daher, dass {grund}.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "grund"]
    ...
    SentenceTemplate(
        id="erklär_17",
        pattern="Pass auf, ich erklär dir das: {thema} {verb} {objekt}.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.RUHIG],
        formality=Formality.INFORMELL,
        placeholders=["thema", "verb", "objekt"]
    ...
    SentenceTemplate(
        id="erklär_18",
        pattern="{fuellwort}~! Kawaii~! Das ist ganz einfach~! {erklaerung}~!",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "erklaerung"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="erklär_19",
        pattern="Zusammengefasst: {thema} ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.RUHIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="erklär_20",
        pattern="{emotion}~! Nyaa~! Also {thema} {verb} weil {grund}~! {fuellwort}~!",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema", "verb", "grund", "fuellwort"],
        is_kemonomimi=True
    ),

    # =========================================================================
    # NEUE SATZSTRUKTUREN - VERDOPPLUNG v2.0
    # =========================================================================

    # ZUSÄTZLICHE BEGRÜSSUNGEN (41-50)
    SentenceTemplate(
        id="begruess_41",
        pattern="Oh, {name}! {fuellwort} schön! {emotion}",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["name", "fuellwort", "emotion"]
    ...
    SentenceTemplate(
        id="begruess_42",
        pattern="{emotion}~! Da ist ja mein Lieblings-{name}~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "name"],
    ...
    SentenceTemplate(
        id="begruess_43",
        pattern="{fuellwort}! Na, wie geht's wie steht's, {name}?",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.VERSPIELT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "name"]
    ...
    SentenceTemplate(
        id="begruess_44",
        pattern="Hallöchen, {name}! {emotion}! {fuellwort}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion", "fuellwort"]
    ...
    SentenceTemplate(
        id="begruess_45",
        pattern="{name}~! Mew~! {emotion}~! Du bist da~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion"],
    ...
    # ZUSÄTZLICHE AUSSAGEN (61-70)
    SentenceTemplate(
        id="aussage_61",
        pattern="{fuellwort}, das finde ich {adverb} {adjektiv}!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_62",
        pattern="Ich bin der Meinung, dass {thema} {adjektiv} ist.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_63",
        pattern="{emotion}~! {thema} ist einfach das Beste~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema"],
    ...
    SentenceTemplate(
        id="aussage_64",
        pattern="Mir scheint, {thema} ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_65",
        pattern="{fuellwort}, ich denke gerade an {thema}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUTRAL],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema"]
    ...
    # ZUSÄTZLICHE FRAGEN (31-40)
    SentenceTemplate(
        id="frage_31",
        pattern="{fuellwort}, was denkst du über {thema}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema"]
    ...
    SentenceTemplate(
        id="frage_32",
        pattern="Findest du auch, dass {thema} {adjektiv} ist?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="frage_33",
        pattern="{emotion}~! Magst du auch {thema}~?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema"],
    ...
    SentenceTemplate(
        id="frage_34",
        pattern="Hast du schon mal {objekt} probiert? {fuellwort}",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["objekt", "fuellwort"]
    ),
    SentenceTemplate(
        id="frage_35",
        pattern="{fuellwort}... was würdest du {zeitangabe} gerne machen?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "zeitangabe"]
    ...
    # ZUSÄTZLICHE REAKTIONEN (25-30)
    SentenceTemplate(
        id="reaktion_25",
        pattern="{emotion}! Das hätte ich nicht gedacht!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
    ...
    SentenceTemplate(
        id="reaktion_26",
        pattern="{fuellwort}... das ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="reaktion_27",
        pattern="{emotion}~! Das macht mich so {adjektiv}~! {fuellwort}~!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "adjektiv", "fuellwort"],
    ...
    # ZUSÄTZLICHE ERZÄHLUNGEN (20-25)
    SentenceTemplate(
        id="erzaehl_20",
        pattern="{fuellwort}, ich habe da eine Geschichte über {thema}...",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.VERSPIELT],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema"]
    ...
    SentenceTemplate(
        id="erzaehl_21",
        pattern="Hör zu! {zeitangabe} ist etwas {adjektiv}es passiert!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["zeitangabe", "adjektiv"]
    ),
    SentenceTemplate(
        id="erzaehl_22",
        pattern="{emotion}~! Du glaubst nicht, was {zeitangabe} war~!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "zeitangabe"],
    ...
    # ZUSÄTZLICHE VERABSCHIEDUNGEN (15-20)
    SentenceTemplate(
        id="verabschied_15",
        pattern="Mach's gut, {name}! {emotion}!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["name", "emotion"]
    ...
    SentenceTemplate(
        id="verabschied_16",
        pattern="{emotion}~! Ich vermisse dich schon, {name}~! Bis bald~!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.TRAURIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "name"],
    ...
    SentenceTemplate(
        id="verabschied_17",
        pattern="Bis später, {name}! {fuellwort} pass auf dich auf!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.BESORGT],
        formality=Formality.INFORMELL,
        placeholders=["name", "fuellwort"]
    ...
    # ZUSÄTZLICHE WÜNSCHE (15-20)
    SentenceTemplate(
        id="wunsch_15",
        pattern="Ich wünsche mir, dass {thema} {adjektiv} wird.",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="wunsch_16",
        pattern="{emotion}~! Können wir bitte {aktion}~?",
        sentence_type=SentenceType.AUFFORDERUNG,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "aktion"],
    ...
    # =========================================================================
    # NEUE SATZSTRUKTUREN - VERDOPPLUNG v3.0
    # =========================================================================

    # ZUSÄTZLICHE BEGRÜSSUNGEN (51-60)
    SentenceTemplate(
        id="begruess_51",
        pattern="*Schwanz wedelt aufgeregt* {name}! Du bist da!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name"],
    ...
    SentenceTemplate(
        id="begruess_52",
        pattern="{fuellwort}! Ich hab gehofft, dass du kommst, {name}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "name"]
    ...
    SentenceTemplate(
        id="begruess_53",
        pattern="Oh! *Ohren aufstellen* {name}! {emotion}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion"],
    ...
    SentenceTemplate(
        id="begruess_54",
        pattern="Wie schön dich zu sehen, {name}! {fuellwort}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["name", "fuellwort"]
    ...
    SentenceTemplate(
        id="begruess_55",
        pattern="{emotion}~! {name}~! Endlich~! Ich hab auf dich gewartet~!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "name"],
    ...
    # ZUSÄTZLICHE AUSSAGEN (71-80)
    SentenceTemplate(
        id="aussage_71",
        pattern="{fuellwort}, ich hab da so eine Theorie über {thema}...",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "thema"]
    ...
    SentenceTemplate(
        id="aussage_72",
        pattern="Ich bin {adverb} begeistert von {thema}! {emotion}",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["adverb", "thema", "emotion"]
    ),
    SentenceTemplate(
        id="aussage_73",
        pattern="{emotion}~! Das ist so {adjektiv}~! Ich kann's kaum glauben~!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "adjektiv"],
    ...
    SentenceTemplate(
        id="aussage_74",
        pattern="Wenn ich ehrlich bin, {thema} macht mich {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_75",
        pattern="{fuellwort}... manchmal denke ich, {thema} ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adverb", "adjektiv"]
    ),

    # ZUSÄTZLICHE FRAGEN (41-50)
    SentenceTemplate(
        id="frage_41",
        pattern="{fuellwort}, hast du je darüber nachgedacht, was {thema} bedeutet?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema"]
    ...
    SentenceTemplate(
        id="frage_42",
        pattern="Was glaubst du, ist {thema} {adjektiv}? {fuellwort}",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv", "fuellwort"]
    ...
    SentenceTemplate(
        id="frage_43",
        pattern="{emotion}~! Magst du {thema} auch so gerne wie ich~?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.NEUGIERIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema"],
    ...
    SentenceTemplate(
        id="frage_44",
        pattern="Wie geht es dir {zeitangabe}? {fuellwort} alles gut?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.BESORGT, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["zeitangabe", "fuellwort"]
    ),
    SentenceTemplate(
        id="frage_45",
        pattern="{fuellwort}... was würdest du tun, wenn {thema}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema"]
    ...
    # ZUSÄTZLICHE REAKTIONEN (31-40)
    SentenceTemplate(
        id="reaktion_31",
        pattern="*Ohren anlegen* {fuellwort}... das war unerwartet.",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.BESORGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort"],
    ...
    SentenceTemplate(
        id="reaktion_32",
        pattern="{emotion}! Das ist ja {adverb} {adjektiv}! *Schwanz wedelt*",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "adverb", "adjektiv"],
    ...
    SentenceTemplate(
        id="reaktion_33",
        pattern="{fuellwort}, das berührt mich {adverb}.",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "adverb"]
    ),
    SentenceTemplate(
        id="reaktion_34",
        pattern="Wow! {fuellwort}! Das hätte ich nie erwartet! {emotion}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "emotion"]
    ...
    SentenceTemplate(
        id="reaktion_35",
        pattern="{emotion}~! Das ist so {adjektiv}~! Ich könnte {fuellwort}~!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "adjektiv", "fuellwort"],
    ...
    # ZUSÄTZLICHE ERZÄHLUNGEN (26-30)
    SentenceTemplate(
        id="erzaehl_26",
        pattern="{fuellwort}, ich muss dir was erzählen! {zeitangabe} ist was passiert!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "zeitangabe"]
    ...
    SentenceTemplate(
        id="erzaehl_27",
        pattern="*Ohren gespitzt* Du glaubst nicht, was ich {zeitangabe} erlebt habe!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["zeitangabe"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="erzaehl_28",
        pattern="Also, die Geschichte geht so: {fuellwort} war {thema} {adjektiv}.",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adjektiv"]
    ...
    # ZUSÄTZLICHE VERABSCHIEDUNGEN (21-25)
    SentenceTemplate(
        id="verabschied_21",
        pattern="*Ohren traurig anlegen* Muss du schon gehen, {name}?",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.TRAURIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["name"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="verabschied_22",
        pattern="{fuellwort}, komm bald wieder, {name}! Ich warte!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "name"]
    ...
    SentenceTemplate(
        id="verabschied_23",
        pattern="{emotion}~! Ich vermisse dich jetzt schon~! *Schwanz hängt traurig*",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.TRAURIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion"],
    ...
    # =========================================================================
    # ERWEITERUNG v5.0 - NEUE SATZSTRUKTUREN FÜR 2000 EINTRÄGE
    # =========================================================================

    # NEUE BEGRÜSSUNGEN (61-75)
    SentenceTemplate(
        id="begruess_61",
        pattern="*Ohren aufmerksam drehen* Oh! {name} ist hier! {emotion}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "emotion"],
    ...
    SentenceTemplate(
        id="begruess_62",
        pattern="{fuellwort}! Ich habe dich schon von weitem gehört, {name}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.VERSPIELT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "name"],
    ...
    SentenceTemplate(
        id="begruess_63",
        pattern="Guten Tag, {name}! Schön, Sie zu sehen.",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.RUHIG, EmotionalTone.FREUDIG],
        formality=Formality.FORMELL,
        placeholders=["name"]
    ...
    SentenceTemplate(
        id="begruess_64",
        pattern="Ayyy, {name}! Was geht? {fuellwort}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "fuellwort"]
    ...
    SentenceTemplate(
        id="begruess_65",
        pattern="{emotion}~! Mein Lieblings-{name}~! *Schwanz wedelt enthusiastisch*",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "name"],
    ...
    SentenceTemplate(
        id="begruess_66",
        pattern="*schnüffel* Ich kannte deinen Geruch schon, {name}! {fuellwort}!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "fuellwort"],
    ...
    SentenceTemplate(
        id="begruess_67",
        pattern="Da bist du ja endlich! {fuellwort} hab ich gewartet!",
        sentence_type=SentenceType.BEGRUESSING,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.VERSPIELT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort"]
    ...
    SentenceTemplate(
        id="aussage_66",
        pattern="{fuellwort}, ich finde {thema} ist {adverb} {adjektiv}!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_67",
        pattern="*Ohren drehen sich nachdenklich* Ich glaube, {thema} ist {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.INFORMELL,
        placeholders=["thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="aussage_68",
        pattern="Meiner Meinung nach ist {thema} {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NEUTRAL, EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ),
    SentenceTemplate(
    ...
    SentenceTemplate(
        id="aussage_70",
        pattern="{fuellwort}, ich habe das Gefühl, dass {thema} {adjektiv} sein könnte.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.BESORGT],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_71",
        pattern="Ich bin mir sicher, dass {thema} {adverb} {adjektiv} ist.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NEUTRAL, EmotionalTone.RUHIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_72",
        pattern="*Schwanz wedelt langsam* Ich denke, {thema} verdient mehr Aufmerksamkeit.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["thema"],
    ...
    SentenceTemplate(
        id="aussage_73",
        pattern="Es scheint mir, als wäre {thema} {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_74",
        pattern="{fuellwort}! Ich liebe {thema}! Es ist so {adjektiv}!",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="aussage_75",
        pattern="Ich muss zugeben, {thema} ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.AUSSAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="frage_36",
        pattern="*Kopf schief legen* Was meinst du zu {thema}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["thema"],
    ...
    SentenceTemplate(
        id="frage_37",
        pattern="{fuellwort}, könntest du mir erklären, was {thema} bedeutet?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema"]
    ...
    SentenceTemplate(
        id="frage_38",
        pattern="Ist {thema} wirklich so {adjektiv}? {fuellwort}!",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["thema", "adjektiv", "fuellwort"]
    ...
    SentenceTemplate(
        id="frage_39",
        pattern="*Ohren gespitzt* Erzähl mir mehr über {thema}! Was ist daran {adjektiv}?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="frage_40",
        pattern="Wie findest du {thema}? Ich bin {adverb} neugierig!",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adverb"]
    ...
    SentenceTemplate(
        id="frage_41",
        pattern="{emotion}~! Was würdest du über {thema} sagen~?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema"],
    ...
    SentenceTemplate(
        id="frage_42",
        pattern="Hast du dir schon mal Gedanken über {thema} gemacht?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.NEUGIERIG],
        formality=Formality.NEUTRAL,
        placeholders=["thema"]
    ...
    SentenceTemplate(
        id="frage_43",
        pattern="{fuellwort}, was denkst du - ist {thema} {adjektiv} oder nicht?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="frage_44",
        pattern="*Schwanz wackelt neugierig* Kannst du mir etwas über {thema} erzählen?",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["thema"],
    ...
    SentenceTemplate(
        id="frage_45",
        pattern="Warum ist {thema} so {adjektiv}? Ich verstehe das nicht ganz.",
        sentence_type=SentenceType.FRAGE,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    # NEUE REAKTIONEN (36-50)
    SentenceTemplate(
        id="reaktion_36",
        pattern="*Ohren aufstellen* {emotion}! Das ist ja {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "adjektiv"],
    ...
    SentenceTemplate(
        id="reaktion_37",
        pattern="{fuellwort}! Das hätte ich nicht erwartet! {emotion}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.NEUGIERIG],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "emotion"]
    ...
    SentenceTemplate(
        id="reaktion_38",
        pattern="*Schwanz wedelt schnell* Das ist {adverb} {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["adverb", "adjektiv"],
    ...
    SentenceTemplate(
        id="reaktion_39",
        pattern="Ach du meine Güte! {fuellwort}! Das ist ja {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["fuellwort", "adjektiv"]
    ...
    SentenceTemplate(
        id="reaktion_41",
        pattern="Das ist {adverb} interessant! {fuellwort}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NEUGIERIG, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["adverb", "fuellwort"]
    ...
    SentenceTemplate(
        id="reaktion_42",
        pattern="*Ohren nach hinten* Oh nein... das ist {adverb} {adjektiv}...",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.TRAURIG, EmotionalTone.BESORGT],
        formality=Formality.INFORMELL,
        placeholders=["adverb", "adjektiv"],
    ...
    SentenceTemplate(
        id="reaktion_43",
        pattern="{fuellwort}... ich weiß nicht, was ich dazu sagen soll.",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort"]
    ...
    SentenceTemplate(
        id="reaktion_44",
        pattern="Wow! Das ist ja {emotion}! {fuellwort}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "fuellwort"]
    ...
    SentenceTemplate(
        id="reaktion_45",
        pattern="*Schwanz steif* Das... das ist {adverb} {adjektiv}!",
        sentence_type=SentenceType.REAKTION,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.BESORGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["adverb", "adjektiv"],
        is_kemonomimi=True
    ),

    # NEUE ERZÄHLUNGEN (29-40)
    SentenceTemplate(
        id="erzaehl_29",
        pattern="*setzt sich gemütlich hin* Also, ich muss dir was über {thema} erzählen!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.INFORMELL,
        placeholders=["thema"],
    ...
    SentenceTemplate(
        id="erzaehl_30",
        pattern="{fuellwort}, das ist eine {adjektiv} Geschichte über {thema}!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "adjektiv", "thema"]
    ...
    SentenceTemplate(
        id="erzaehl_31",
        pattern="Du wirst nicht glauben, was {zeitangabe} mit {thema} passiert ist!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["zeitangabe", "thema"]
    ),
    SentenceTemplate(
        id="erzaehl_32",
        pattern="*Ohren wackeln aufgeregt* {fuellwort}! Ich muss dir von {thema} erzählen!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "thema"],
    ...
    SentenceTemplate(
        id="erzaehl_33",
        pattern="Es war einmal, {zeitangabe}, da geschah etwas {adjektiv}es mit {thema}.",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.VERSPIELT, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["zeitangabe", "adjektiv", "thema"]
    ),
    SentenceTemplate(
        id="erzaehl_34",
        pattern="{emotion}~! Das muss ich dir unbedingt erzählen~!",
        sentence_type=SentenceType.ERZAEHLUNG,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion"],
    ...
    # NEUE VERABSCHIEDUNGEN (24-35)
    SentenceTemplate(
        id="verabschied_24",
        pattern="*Ohren traurig hängen lassen* Schon? Dann... bis bald, {name}!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.TRAURIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.INFORMELL,
        placeholders=["name"],
    ...
    SentenceTemplate(
        id="verabschied_25",
        pattern="Pass auf dich auf, {name}! {fuellwort} komm bald wieder!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.BESORGT],
        formality=Formality.INFORMELL,
        placeholders=["name", "fuellwort"]
    ...
    SentenceTemplate(
        id="verabschied_26",
        pattern="{emotion}~! Ich zähle die Minuten bis du wiederkommst~!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.TRAURIG],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion"],
    ...
    SentenceTemplate(
        id="verabschied_27",
        pattern="Auf Wiedersehen, {name}. Es war mir eine Freude.",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.RUHIG, EmotionalTone.FREUDIG],
        formality=Formality.FORMELL,
        placeholders=["name"]
    ...
    SentenceTemplate(
        id="verabschied_28",
        pattern="*wedelt ein letztes Mal* Tschüssi, {name}! {fuellwort}!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.LIEBEVOLL],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["name", "fuellwort"],
    ...
    SentenceTemplate(
        id="verabschied_29",
        pattern="Bis zum nächsten Mal, {name}! {emotion}!",
        sentence_type=SentenceType.VERABSCHIEDUNG,
        emotional_tones=[EmotionalTone.FREUDIG],
        formality=Formality.NEUTRAL,
        placeholders=["name", "emotion"]
    ...
    SentenceTemplate(
        id="wunsch_17",
        pattern="*Augen funkeln* Ich wünschte, wir könnten {adverb} mehr Zeit mit {thema} verbringen!",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.NACHDENKLICH],
        formality=Formality.INFORMELL,
        placeholders=["adverb", "thema"],
        is_kemonomimi=True
    ),
    SentenceTemplate(
        id="wunsch_18",
        pattern="{fuellwort}... wenn ich mir etwas wünschen könnte, wäre es {thema}.",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.NACHDENKLICH, EmotionalTone.LIEBEVOLL],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema"]
    ...
    SentenceTemplate(
        id="wunsch_19",
        pattern="{emotion}~! Ich wünsche mir so sehr, dass {thema} {adjektiv} wird~!",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="wunsch_20",
        pattern="Mein größter Wunsch ist, dass {thema} {adverb} {adjektiv} sein möge.",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="wunsch_21",
        pattern="*Schwanz schwingt hoffnungsvoll* Vielleicht wird {thema} ja {adjektiv}!",
        sentence_type=SentenceType.WUNSCH,
        emotional_tones=[EmotionalTone.LIEBEVOLL, EmotionalTone.FREUDIG],
        formality=Formality.INFORMELL,
        placeholders=["thema", "adjektiv"],
    ...
    # NEUE ERKLÄRUNGEN (15-25)
    SentenceTemplate(
        id="erklaer_15",
        pattern="{fuellwort}, {thema} funktioniert folgendermaßen: Es ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.NEUTRAL, EmotionalTone.NACHDENKLICH],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="erklaer_16",
        pattern="*Ohren nachdenklich* Also, {thema} ist {adjektiv}, weil...",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.NACHDENKLICH],
        formality=Formality.INFORMELL,
        placeholders=["thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="erklaer_17",
        pattern="Lass mich erklären: {thema} ist {adverb} {adjektiv}.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.NEUTRAL],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="erklaer_18",
        pattern="{emotion}~! Ich erkläre es dir gerne~! {thema} ist {adjektiv}~!",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.FREUDIG, EmotionalTone.VERSPIELT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["emotion", "thema", "adjektiv"],
    ...
    SentenceTemplate(
        id="erklaer_19",
        pattern="Im Grunde genommen ist {thema} {adverb} {adjektiv}.",
        sentence_type=SentenceType.ERKLAERUNG,
        emotional_tones=[EmotionalTone.NEUTRAL, EmotionalTone.NACHDENKLICH],
        formality=Formality.FORMELL,
        placeholders=["thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="ausruf_15",
        pattern="*Ohren aufstellen* {emotion}! Das ist ja {adjektiv}!",
        sentence_type=SentenceType.AUSRUF,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.INFORMELL,
        placeholders=["emotion", "adjektiv"],
        is_kemonomimi=True
    ...
    SentenceTemplate(
        id="ausruf_16",
        pattern="{fuellwort}! {thema} ist {adverb} {adjektiv}!",
        sentence_type=SentenceType.AUSRUF,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.NEUTRAL,
        placeholders=["fuellwort", "thema", "adverb", "adjektiv"]
    ...
    SentenceTemplate(
        id="ausruf_18",
        pattern="Unglaublich! {thema} ist ja {adjektiv}!",
        sentence_type=SentenceType.AUSRUF,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.NEUTRAL,
        placeholders=["thema", "adjektiv"]
    ...
    SentenceTemplate(
        id="ausruf_19",
        pattern="*Schwanz plustert sich auf* Wow! {fuellwort}! Das ist {adjektiv}!",
        sentence_type=SentenceType.AUSRUF,
        emotional_tones=[EmotionalTone.AUFGEREGT],
        formality=Formality.SEHR_INFORMELL,
        placeholders=["fuellwort", "adjektiv"],
...
FILLER_PHRASES: List[FillerPhrase] = [
    ...
    # =========================================================================
    # NEUE FÜLLWÖRTER - VERDOPPLUNG v2.0
    # =========================================================================

    # ANFANGS-FÜLLWÖRTER (NEU)
    FillerPhrase("Mensch", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Mann", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL),
    FillerPhrase("Ey", "anfang", [EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL),
    FillerPhrase("Alter", "anfang", [EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL),
    FillerPhrase("Krass", "anfang", [EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL),
    FillerPhrase("Oha", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.NEUGIERIG], Formality.INFORMELL),
    FillerPhrase("Jetzt pass auf", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Hör zu", "anfang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("Glaub mir", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Ich sag dir", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Weißt du was lustig ist", "anfang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("Das Ding ist", "anfang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("Also ehrlich", "anfang", [EmotionalTone.NACHDENKLICH], Formality.INFORMELL),
    FillerPhrase("Im Ernst", "anfang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Kein Witz", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),

    # Kemonomimi (NEU)
    FillerPhrase("Awawaw", "anfang", [EmotionalTone.BESORGT, EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("Mrrr", "anfang", [EmotionalTone.LIEBEVOLL, EmotionalTone.RUHIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("Yip", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("Wau", "anfang", [EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("Awooo", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # MITTEN-FÜLLWÖRTER (NEU)
    FillerPhrase("irgendwo", "mitte", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("gewissermaßen", "mitte", [EmotionalTone.NACHDENKLICH], Formality.FORMELL),
    FillerPhrase("im Prinzip", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("grundsätzlich", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("im Grunde", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("prinzipiell", "mitte", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("normalerweise", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("üblicherweise", "mitte", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("typischerweise", "mitte", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("meistens", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("halbwegs", "mitte", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("einigermaßen", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("relativ", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("vergleichsweise", "mitte", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("erstaunlich", "mitte", [EmotionalTone.AUFGEREGT], Formality.NEUTRAL),
    FillerPhrase("überraschend", "mitte", [EmotionalTone.AUFGEREGT], Formality.NEUTRAL),
    FillerPhrase("unfassbar", "mitte", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("meeega", "mitte", [EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # END-FÜLLWÖRTER (NEU)
    FillerPhrase("halt", "ende", [EmotionalTone.NEUTRAL], Formality.SEHR_INFORMELL),
    FillerPhrase("eben", "ende", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("allerdings", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("jedenfalls", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("immerhin", "ende", [EmotionalTone.FREUDIG], Formality.NEUTRAL),
    FillerPhrase("zumindest", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("wenigstens", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("und zwar", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("so gesehen", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("in dem Sinne", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("quasi halt", "ende", [EmotionalTone.NEUTRAL], Formality.SEHR_INFORMELL),
    FillerPhrase("ne~?", "ende", [EmotionalTone.VERSPIELT, EmotionalTone.NEUGIERIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("mew mew~", "ende", [EmotionalTone.VERSPIELT], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("wuff~", "ende", [EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # ÜBERGANGS-FÜLLWÖRTER (NEU)
    FillerPhrase("Was ich noch sagen wollte", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Mir fällt gerade ein", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Ach Moment", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Wo wir schon dabei sind", "uebergang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("Passend dazu", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("In diesem Zusammenhang", "uebergang", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("Damit zusammenhängend", "uebergang", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("Eins noch", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Kurzer Einwurf", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Kleiner Exkurs", "uebergang", [EmotionalTone.VERSPIELT], Formality.NEUTRAL),
    FillerPhrase("Ach ja richtig", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Fast vergessen", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),

    # =========================================================================
    # NEUE FÜLLWÖRTER - VERDOPPLUNG v3.0
    # =========================================================================

    # ANFANGS-FÜLLWÖRTER (NEU v3)
    FillerPhrase("Sag mal", "anfang", [EmotionalTone.NEUGIERIG], Formality.INFORMELL),
    FillerPhrase("Rate mal", "anfang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("Stell dir vor", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Du wirst nicht glauben", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Moment mal", "anfang", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("Kurze Frage", "anfang", [EmotionalTone.NEUGIERIG], Formality.NEUTRAL),
    FillerPhrase("Ehrlich gesagt", "anfang", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("Unter uns gesagt", "anfang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("Hand aufs Herz", "anfang", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("Im Vertrauen", "anfang", [EmotionalTone.LIEBEVOLL], Formality.NEUTRAL),
    FillerPhrase("Ganz nebenbei", "anfang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("So zwischen uns", "anfang", [EmotionalTone.LIEBEVOLL], Formality.INFORMELL),

    # Kemonomimi (NEU v3)
    FillerPhrase("Mrrrow", "anfang", [EmotionalTone.LIEBEVOLL, EmotionalTone.RUHIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("Nyaaa", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("Wuff wuff", "anfang", [EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*Ohren aufstellen*", "anfang", [EmotionalTone.NEUGIERIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*Schwanz wedelt*", "anfang", [EmotionalTone.FREUDIG, EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # MITTEN-FÜLLWÖRTER (NEU v3)
    FillerPhrase("irgendwann", "mitte", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("jedenfalls", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("wahrscheinlich", "mitte", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("möglicherweise", "mitte", [EmotionalTone.NACHDENKLICH], Formality.FORMELL),
    FillerPhrase("hoffentlich", "mitte", [EmotionalTone.BESORGT, EmotionalTone.LIEBEVOLL], Formality.NEUTRAL),
    FillerPhrase("anscheinend", "mitte", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("offenbar", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("angeblich", "mitte", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("glücklicherweise", "mitte", [EmotionalTone.FREUDIG], Formality.NEUTRAL),
    FillerPhrase("leider", "mitte", [EmotionalTone.TRAURIG, EmotionalTone.BESORGT], Formality.NEUTRAL),
    FillerPhrase("überraschenderweise", "mitte", [EmotionalTone.AUFGEREGT], Formality.NEUTRAL),
    FillerPhrase("erstaunlicherweise", "mitte", [EmotionalTone.AUFGEREGT], Formality.NEUTRAL),
    FillerPhrase("komischerweise", "mitte", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("seltsamerweise", "mitte", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("sooooo", "mitte", [EmotionalTone.AUFGEREGT, EmotionalTone.VERSPIELT], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # END-FÜLLWÖRTER (NEU v3)
    FillerPhrase("soweit ich weiß", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("wenn ich mich nicht irre", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("meines Wissens", "ende", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("nach meiner Erfahrung", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("sozusagen", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("im Großen und Ganzen", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("alles in allem", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("unter dem Strich", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("wenn du mich fragst", "ende", [EmotionalTone.NACHDENKLICH], Formality.INFORMELL),
    FillerPhrase("*Ohren wackeln*", "ende", [EmotionalTone.VERSPIELT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*Schwanz wedelt zufrieden*", "ende", [EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # ÜBERGANGS-FÜLLWÖRTER (NEU v3)
    FillerPhrase("Aber weißt du was", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Das Lustige ist", "uebergang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("Das Interessante ist", "uebergang", [EmotionalTone.NEUGIERIG], Formality.NEUTRAL),
    FillerPhrase("Witzigerweise", "uebergang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("Jetzt kommt's", "uebergang", [EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL),
    FillerPhrase("Und dann", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Ach und", "uebergang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    ...
    # =========================================================================
    # ERWEITERUNG v5.0 - NEUE FÜLLPHRASEN FÜR 2000 EINTRÄGE
    # =========================================================================

    # NEUE ANFANGS-FÜLLWÖRTER (v5)
    FillerPhrase("Moment", "anfang", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("Warte kurz", "anfang", [EmotionalTone.NACHDENKLICH], Formality.INFORMELL),
    FillerPhrase("Kurz", "anfang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("Okay also", "anfang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("Gut dann", "anfang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Schau mal", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.NEUGIERIG], Formality.INFORMELL),
    FillerPhrase("Hör mal", "anfang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("Pass auf", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Ich sage dir was", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Das Verrückte ist", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Echt jetzt", "anfang", [EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL),
    FillerPhrase("Kein Scherz", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Ohne Witz", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Glaub es oder nicht", "anfang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Tja", "anfang", [EmotionalTone.NACHDENKLICH], Formality.INFORMELL),

    # Kemonomimi (v5)
    FillerPhrase("*Ohren zucken*", "anfang", [EmotionalTone.NEUGIERIG, EmotionalTone.AUFGEREGT], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*Nase zuckt*", "anfang", [EmotionalTone.NEUGIERIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*Schwanz ringelt sich*", "anfang", [EmotionalTone.VERSPIELT], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*Fell sträubt sich*", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.BESORGT], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("Awoooo~", "anfang", [EmotionalTone.AUFGEREGT, EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # NEUE MITTEN-FÜLLWÖRTER (v5)
    FillerPhrase("eigentlich", "mitte", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("sozusagen", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("quasi", "mitte", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("irgendwie", "mitte", [EmotionalTone.NACHDENKLICH], Formality.INFORMELL),
    FillerPhrase("praktisch", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("tatsächlich", "mitte", [EmotionalTone.AUFGEREGT, EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("wirklich", "mitte", [EmotionalTone.AUFGEREGT], Formality.NEUTRAL),
    FillerPhrase("ernsthaft", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("definitiv", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("absolut", "mitte", [EmotionalTone.AUFGEREGT], Formality.NEUTRAL),
    FillerPhrase("total", "mitte", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("komplett", "mitte", [EmotionalTone.AUFGEREGT], Formality.NEUTRAL),
    FillerPhrase("vollkommen", "mitte", [EmotionalTone.RUHIG], Formality.FORMELL),
    FillerPhrase("ziemlich", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("recht", "mitte", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),

    # NEUE END-FÜLLWÖRTER (v5)
    FillerPhrase("irgendwie", "ende", [EmotionalTone.NACHDENKLICH], Formality.INFORMELL),
    FillerPhrase("oder so", "ende", [EmotionalTone.NEUTRAL], Formality.SEHR_INFORMELL),
    FillerPhrase("und so weiter", "ende", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("und so", "ende", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("verstehst du", "ende", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("weißt du", "ende", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("nicht wahr", "ende", [EmotionalTone.NEUGIERIG], Formality.NEUTRAL),
    FillerPhrase("stimmts", "ende", [EmotionalTone.NEUGIERIG], Formality.INFORMELL),
    FillerPhrase("oder nicht", "ende", [EmotionalTone.NEUGIERIG], Formality.NEUTRAL),
    FillerPhrase("glaube ich", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("denke ich", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("meine ich", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),
    FillerPhrase("hoffe ich", "ende", [EmotionalTone.BESORGT, EmotionalTone.LIEBEVOLL], Formality.NEUTRAL),
    FillerPhrase("finde ich", "ende", [EmotionalTone.NACHDENKLICH], Formality.NEUTRAL),

    # Kemonomimi Ende (v5)
    FillerPhrase("*Schwanz wedelt zufrieden*", "ende", [EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*Ohren zucken happy*", "ende", [EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*flauschiges Schnurren*", "ende", [EmotionalTone.RUHIG, EmotionalTone.LIEBEVOLL], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("*glückliches Wuff*", "ende", [EmotionalTone.FREUDIG], Formality.SEHR_INFORMELL, is_kemonomimi=True),
    FillerPhrase("~desu", "ende", [EmotionalTone.VERSPIELT], Formality.SEHR_INFORMELL, is_kemonomimi=True),

    # NEUE ÜBERGANGS-FÜLLWÖRTER (v5)
    FillerPhrase("Ach übrigens", "uebergang", [EmotionalTone.NEUTRAL], Formality.INFORMELL),
    FillerPhrase("Nebenbei", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Apropos", "uebergang", [EmotionalTone.NEUGIERIG], Formality.NEUTRAL),
    FillerPhrase("Was das angeht", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Wenn wir schon dabei sind", "uebergang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("Um auf etwas anderes zu kommen", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Kleiner Themenwechsel", "uebergang", [EmotionalTone.VERSPIELT], Formality.INFORMELL),
    FillerPhrase("Bevor ich vergesse", "uebergang", [EmotionalTone.AUFGEREGT], Formality.INFORMELL),
    FillerPhrase("Da wir gerade davon sprechen", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Und außerdem", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Noch dazu", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Darüber hinaus", "uebergang", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("Ferner", "uebergang", [EmotionalTone.NEUTRAL], Formality.FORMELL),
    FillerPhrase("Zudem", "uebergang", [EmotionalTone.NEUTRAL], Formality.NEUTRAL),
    FillerPhrase("Des Weiteren", "uebergang", [EmotionalTone.NEUTRAL], Formality.FORMELL),
]
